...
基于 tree-sitter 的代码块语法高亮，支持 Rust、Python、JavaScript、C#、HTML、CSS、JSON、Bash。
...
| `--github-token <token>` | GitHub API 访问令牌 |
| `--github-repo <owner/repo>` | GitHub 仓库（用于自动链接检测） |
| `--agent <命令>` | AI 辅助命令（如 `claude`），启用聊天面板 |
