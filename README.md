...
- **GitHub 引用检测** — Issue/PR/用户引用自动识别与状态悬浮展示
- **Diff 视图** — 文件变更对比（AI 编辑场景）
- **AI 编辑器内核** — 支持流式文本追加与 Agent Client Protocol (ACP) 基础框架
- **流式输出** — 支持 AI 场景的流式文本追加
...
| gix | Git 操作 |
| reqwest | HTTP 客户端 |
| agent-client-protocol | AI Agent 通信协议 |
| open | 跨平台打开文件/目录 |
